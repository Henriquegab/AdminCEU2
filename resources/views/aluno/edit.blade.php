    ...
    <form method="post" action="{{ route('alunos.update', ['aluno' => $aluno]) }}">
        ...
        <div class="form-row">
            ...
            <div class="col-md-2 mb-3">
                ...
                <input type="text" value="{{ $aluno->telefone }}" class="form-control @error('telefone') is-invalid @enderror" name="telefone" placeholder="(38) 94002-8922" data-mask="(00) 000000000">
